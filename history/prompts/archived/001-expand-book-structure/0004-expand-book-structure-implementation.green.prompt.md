...
- `apps/learn-app/docs/08-TypeScript-Fundamentals/intro.md`
- `apps/learn-app/docs/09-Realtime-Voice-Agents/intro.md`
- `apps/learn-app/docs/10-Docker-Kubernetes/intro.md`
- `apps/learn-app/docs/11-Data-State-Memory/intro.md`
- `apps/learn-app/docs/12-Event-Driven-Architecture/intro.md`
- `apps/learn-app/docs/13-Stateful-Agents/intro.md`
...
- `apps/learn-app/docs/{08,09,10,11,12,13}-{PartName}/`
...
- `apps/learn-app/docs/{08,09,10,11,12,13}-{PartName}/intro.md` (6 files)
...
- `apps/learn-app/docs/04-Modern-Python-with-Type-Hints/` → `04-Python-The-Language-of-AI-Agents/`
- `apps/learn-app/docs/05-Spec-Kit-Methodology/` → `05-Spec-Kit-Plus-Methodology/`
