...
Now let's plan the full structure and it will previewed for docasorus for all parts and chapters @apps/learn-app/docs/ and same in our presetup for ref
...
- Storage: File-based in `apps/learn-app/docs/`
...
1. 7 part folders in `apps/learn-app/docs/`
