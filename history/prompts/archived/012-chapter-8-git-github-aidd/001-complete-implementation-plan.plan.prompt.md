...
**Part II: Natural Language Prompts (100 min)** - Lessons 5-8 5. **Lesson 5**: Branches for Experimentation (25 min) - Feature branches for safe testing 6. **Lesson 6**: GitHub Integration (20 min) - Remote setup, authentication, push/pull 7. **Lesson 7**: Pull Requests (30 min) - Code review workflow, documentation 8. **Lesson 8**: IDE Setup (25 min) - VS Code + Git integration + AI extensions

**Capstone Integration** - Lesson 9 9. **Lesson 9**: Capstone Exercise (30 min) - Full project workflow (calculator with AI, Git tracking, GitHub push, PR creation)
...
8. **Verify files persist** to `apps/learn-app/docs/02-AI-Tool-Landscape/08-git-and-github/` after writing
...
_Plan created by chapter-planner agent on behalf of architect user. All constitutional principles (evals-first, spec-first, validation-first, AIDD methodology) integrated throughout._
