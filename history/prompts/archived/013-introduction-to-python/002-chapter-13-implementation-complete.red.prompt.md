...
files_created:
  ...
  - "apps/learn-app/docs/04-Part-4-Python-Fundamentals/13-introduction-to-python/01-what-is-python.md"
  - "apps/learn-app/docs/04-Part-4-Python-Fundamentals/13-introduction-to-python/02-installing-python.md"
  - "apps/learn-app/docs/04-Part-4-Python-Fundamentals/13-introduction-to-python/03-your-first-program.md"
  - "apps/learn-app/docs/04-Part-4-Python-Fundamentals/13-introduction-to-python/04-thinking-like-ai-developer.md"
...
links:
  ...
  chapter_dir: "apps/learn-app/docs/04-Part-4-Python-Fundamentals/13-introduction-to-python/"
...
**Location**: `apps/learn-app/docs/04-Part-4-Python-Fundamentals/13-introduction-to-python/`
...
4. **Merge to main**
   ...
   ```bash
   git add apps/learn-app/docs/04-Part-4-Python-Fundamentals/13-introduction-to-python/
