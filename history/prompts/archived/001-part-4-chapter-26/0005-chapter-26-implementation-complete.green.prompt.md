...
links:
  ...
  pr: null
files:
  - apps/learn-app/docs/04-Part-4-Python-Fundamentals/26-metaclasses-dataclasses/intro.md (created)
  - apps/learn-app/docs/04-Part-4-Python-Fundamentals/26-metaclasses-dataclasses/01-understanding-metaclasses.md (created, 541 lines)
  - apps/learn-app/docs/04-Part-4-Python-Fundamentals/26-metaclasses-dataclasses/02-practical-metaclass-patterns.mdx (created, 898 lines)
  - apps/learn-app/docs/04-Part-4-Python-Fundamentals/26-metaclasses-dataclasses/03-introduction-to-dataclasses.md (created, 533 lines)
  - apps/learn-app/docs/04-Part-4-Python-Fundamentals/26-metaclasses-dataclasses/04-advanced-dataclass-features.mdx (created, 797 lines)
  - apps/learn-app/docs/04-Part-4-Python-Fundamentals/26-metaclasses-dataclasses/lesson-5-choosing-the-right-tool.mdx (created, 813 lines)
tests:
...
- Created chapter directory: apps/learn-app/docs/04-Part-4-Python-Fundamentals/26-metaclasses-dataclasses/
...
- 7 patterns with 6 code examples: validation, registration, singleton, abstract enforcement, Django-like, **init_subclass**
...
- 6 code examples: default_factory, metadata, **post_init**, InitVar, JSON, API model
...
- 📁 Files: Created 6 files (intro.md + 5 lessons), total 3,582 lines, apps/learn-app/docs/04-Part-4-Python-Fundamentals/26-metaclasses-dataclasses/
