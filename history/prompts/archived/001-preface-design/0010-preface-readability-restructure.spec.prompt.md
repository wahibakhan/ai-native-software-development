...
labels:
  ["preface", "readability", "structure", "visual-hierarchy", "user-experience"]
links:
  spec: null
  ticket: null
  adr: null
...
- 📁 Files: Single file modified: `apps/learn-app/docs/preface-agent-native.mdx` (568 → 558 lines, consolidated)
