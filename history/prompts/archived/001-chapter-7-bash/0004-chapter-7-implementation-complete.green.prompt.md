...
labels:
  ["chapter-7", "bash-essentials", "educational-content", "implementation"]
links:
  ...
  pr: null
files:
  - apps/learn-app/docs/02-AI-Tool-Landscape/07-bash-essentials/01-terminal-interface.md
  - apps/learn-app/docs/02-AI-Tool-Landscape/07-bash-essentials/02-navigation-files.md
  - apps/learn-app/docs/02-AI-Tool-Landscape/07-bash-essentials/03-viewing-searching.md
  - apps/learn-app/docs/02-AI-Tool-Landscape/07-bash-essentials/04-environment-packages.md
  - apps/learn-app/docs/02-AI-Tool-Landscape/07-bash-essentials/05-processes-troubleshooting.md
  - apps/learn-app/docs/02-AI-Tool-Landscape/07-bash-essentials/06-natural-language-prompts.md
  - apps/learn-app/docs/02-AI-Tool-Landscape/07-bash-essentials/07-professional-habits.md
  - apps/learn-app/docs/02-AI-Tool-Landscape/07-bash-essentials/08-real-world-workflows.md
  - apps/learn-app/docs/02-AI-Tool-Landscape/07-bash-essentials/README.md
