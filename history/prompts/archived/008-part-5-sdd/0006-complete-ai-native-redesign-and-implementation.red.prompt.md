...
links:
  ...
  pr: null
files:
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/25-specification-driven-development-fundamentals/01-your-companion-built-something-terrible.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/25-specification-driven-development-fundamentals/02-why-did-this-team-ship-in-half-the-time.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/25-specification-driven-development-fundamentals/03-watch-what-your-companion-does-with-a-bad-spec.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/25-specification-driven-development-fundamentals/04-trace-one-project-through-the-sdd-loop.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/25-specification-driven-development-fundamentals/05-here-is-what-i-believe-about-specifications.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/01-help-your-companion-write-a-better-spec.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/02-set-up-your-project-with-specifyplus.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/03-make-your-acceptance-criteria-so-clear-that-ai-understands.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/04-run-sp-specify-with-your-companion.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/05-run-sp-plan-and-see-the-implementation-plan.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/06-decompose-your-spec-into-atomic-tasks.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/07-build-your-grading-system-spec-end-to-end.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/08-mini-project-1-build-a-python-calculator-spec-first.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/09-mini-project-2-write-a-production-grading-system-spec.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/01-watch-your-companions-coordinate.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/02-design-team-workflows-with-specifications.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/03-trace-sdd-through-your-company.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/04-see-how-specs-flow-through-everything.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/05-sdd-in-the-wild-real-companies.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/06-write-your-professional-commitment.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/07-capstone-part-1-decompose-your-spec.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/08-capstone-part-2-implement-in-parallel.md
  - apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/09-capstone-part-3-reflect-on-scale.md
...
**Total**: 16,153 words across 5 lessons in `apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/25-specification-driven-development-fundamentals/`
...
**Total**: 21,591 words across 9 files in `apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/`
...
**Total**: 22,505 words across 10 files in `apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/`
...
- `apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/25-specification-driven-development-fundamentals/IMPLEMENTATION_CHECKLIST.md`
- `apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/26-specifyplus-hands-on/README.md`
- `apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/27-real-world-spec-kit-workflows/README.md`
- `apps/learn-app/docs/05-Spec-Kit-Plus-Methodology/README.md` (updated)
