...
- [ ] T001 [P] Invoke content-implementer subagent for Lesson 1 with evaluation skill in apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/01-origin-story.md
  ...
  - **Output File**: `apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/01-origin-story.md`
...
- [ ] T006 Invoke content-implementer subagent for Lesson 2 with evaluation skill in apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/02-installation-and-authentication.md
  ...
  - **Output File**: `apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/02-installation-and-authentication.md`
...
- [ ] T011 Invoke content-implementer subagent for Lesson 3 with evaluation skill in apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/03-subagents.md
  ...
  - **Output File**: `apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/03-subagents.md`
...
- [ ] T017 Invoke content-implementer subagent for Lesson 4 with evaluation skill in apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/04-agent-skills.md
  ...
  - **Output File**: `apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/04-agent-skills.md`
...
- [ ] T026 Invoke content-implementer subagent for Lesson 5 with evaluation skill in apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/05-mcp-servers-and-workflows.md
  ...
  - **Output File**: `apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/05-mcp-servers-and-workflows.md`
...
- [ ] T030 Create chapter-level overview and introduction in apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/README.md
  ...
  - **Effort**: 2 hours
  - **Deliverable**: `apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/README.md`

- [ ] T031 Create chapter-level reflection prompt (append to Lesson 5) in apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/05-mcp-servers-and-workflows.md
...
- [ ] T033 Create Docusaurus _category_.json for chapter in apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/_category_.json
...
- [ ] T034 [P] Create supplementary resources list in apps/learn-app/docs/02-AI-Tool-Landscape/05-claude-code-features-and-workflows/supplementary-resources.md
