...
**Test**: All existing chapter folders in `apps/learn-app/docs/` match the new chapter mapping. No orphaned files. All content preserved in git history.
...
**Independent Test**: All existing chapter folders in `apps/learn-app/docs/` match the new chapter mapping. Run `git log` to verify all old content is preserved in history.
...
- [x] T013 [US2] Restructure Part 1 physical content (DEFERRED: Content merging requires review) in `/Users/mjs/Documents/code/panaversity-official/tutorgpt-build/colearning-python/apps/learn-app/docs/01-Introducing-AI-Driven-Development/`
...
- [x] T015 [US2] Restructure Part 3 physical content (DEFERRED: Content merging requires review) in `/Users/mjs/Documents/code/panaversity-official/tutorgpt-build/colearning-python/apps/learn-app/docs/03-Prompt-and-Context-Engineering/`
...
**Story Goal**: Reorganize physical directories under `apps/learn-app/docs/` to match the new 13-part, 46-chapter structure.
...
- [x] T019 [US4] Rename Part 4 folder in `/Users/mjs/Documents/code/panaversity-official/tutorgpt-build/colearning-python/apps/learn-app/docs/`

  - Rename: `04-Modern-Python-with-Type-Hints/` → `04-Python-The-Language-of-AI-Agents/`
  - Update `_category_.json` if present

- [x] T020 [US4] Rename Part 5 folder in `/Users/mjs/Documents/code/panaversity-official/tutorgpt-build/colearning-python/apps/learn-app/docs/`
...
- [x] T036 [P] [Polish] Create Docusaurus scaffolding for Parts 8-13 in `/Users/mjs/Documents/code/panaversity-official/tutorgpt-build/colearning-python/apps/learn-app/docs/`
