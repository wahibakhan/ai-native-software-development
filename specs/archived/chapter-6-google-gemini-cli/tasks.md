...
3. **Technical Review**: Invoke validation-auditor subagent for accuracy validation
4. **Proof Validation**: Invoke factual-verifier subagent for editorial quality
...
Before proceeding to implementation (content-implementer subagent), confirm:
